...
local C = {
    ink = Color3.fromRGB(7, 5, 14),
    surface = Color3.fromRGB(14, 11, 24),
    surface2 = Color3.fromRGB(27, 20, 43),
    border = Color3.fromRGB(76, 54, 112),
    red = Color3.fromRGB(168, 85, 247),
    coral = Color3.fromRGB(216, 132, 252),
    violet = Color3.fromRGB(124, 92, 255),
    cyan = Color3.fromRGB(139, 211, 255),
    white = Color3.fromRGB(248, 246, 255),
    text = Color3.fromRGB(226, 219, 241),
    muted = Color3.fromRGB(166, 151, 195),
    off = Color3.fromRGB(61, 45, 86),
    card = Color3.fromRGB(22, 17, 37),
}
...
shadow.Size = UDim2.fromScale(0.935, 0.855)
...
window.Size = UDim2.fromScale(0.92, 0.84)
...
nav.Size = UDim2.fromScale(0.48, 0.60)
...
local function makeCard(parent, name, position, size, edgeColor)
    ...
    card.MouseEnter:Connect(function()
        tween(card, 0.16, {BackgroundColor3 = Color3.fromRGB(34, 25, 56)})
